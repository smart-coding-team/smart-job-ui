<template>
  <div class="login">
    <el-form
      ...
      class="login-form"
    >
      <h3 class="title">smart-job任务调度系统</h3>
      ...
      <el-form-item
        v-if="loginForm.loginType === 1 || loginForm.loginType === 2"
        prop="imageCode"
      >
        <el-input
        ...
        <div class="login-code">
          <img :src="codeUrl" @click="getImageCode" class="login-code-img" />
        </div>
      </el-form-item>
    ...
    <div class="el-login-footer">
      <span>Copyright © 2018-2020 wuque All Rights Reserved.</span>
    </div>
  </div>
</template>
