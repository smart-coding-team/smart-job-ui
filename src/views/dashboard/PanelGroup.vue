    ...
    <el-col :xs="12" :sm="12" :lg="5" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('chartInfo')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countJobLogTotal" :duration="2600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="5" class="card-panel-col">
      ...
      <div class="card-panel" @click="handleSetLineChartData('chartInfo')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="runningCount" :duration="3600" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="5" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('chartInfo')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countJobTotal" :duration="3000" class="card-panel-num" />
        </div>
      </div>
    </el-col>
    <el-col :xs="12" :sm="12" :lg="5" class="card-panel-col">
      <div class="card-panel" @click="handleSetLineChartData('chartInfo')">
        ...
        <div class="card-panel-description">
          ...
          <count-to :start-val="0" :end-val="countJobExecutorTotal" :duration="3200" class="card-panel-num" />
        </div>
      </div>
    </el-col>
